...
export default class TaskList extends Component {
    ...
    componentDidMount = async () => {
        ...
        this.setState({showDoneTask: savedState.showDoneTask}, this.filterTasks)
    ...
    filterTasks = () => {
        ...
        JSON.stringify({showDoneTask: this.state.showDoneTask}))
    }
    ...
    toggleTask = async taskId => {
        try {
            console.log(`${server}/tasks/${taskId}/toggle`)
